...
THREEx.Portal360 = function(videoImageURL, doorWidth, doorHeight){
	...
	var glowMesh = this._buildGlowMesh(doorWidth, doorHeight)
 ...
 * create frameMesh for the frame of the portal
 */
THREEx.Portal360.prototype._buildGlowMesh = function(width, height){
	...
	var glowMesh = new THREE.Mesh(geometry, material);
